...
const LevelScript level_testmap_entry[] = {
	INIT_LEVEL(),
	LOAD_YAY0(0x07, _testmap_segment_7SegmentRomStart, _testmap_segment_7SegmentRomEnd), 
	...
	AREA(1, testmap_area_1),
		...
		MACRO_OBJECTS(testmap_area_1_macro_objs),
		STOP_MUSIC(0),
